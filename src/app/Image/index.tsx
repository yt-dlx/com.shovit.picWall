    ...
    <View className="absolute inset-0 justify-center items-center">
      ...
      <Animated.View className="w-4/5 rounded-3xl p-5 border-4" style={[{ backgroundColor: Colorizer("#0C0C0C", 1.0), borderColor: Colorizer("#25BE8B", 1.0) }, modalStyle]}>
        <View className="items-center">
          ...
          <Text className="mt-2.5 text-5xl" style={{ fontFamily: "PlayfairDisplay_Regular", color: Colorizer("#25BE8B", 1.0) }}>
            Success
          </Text>
          <Text className="my-2.5 text-center text-lg" style={{ fontFamily: "PlayfairDisplay_Regular", color: Colorizer("#25BE8B", 1.0) }}>
            {message}
          </Text>
          <TouchableOpacity className="mt-2.5 px-5 py-2 rounded-2xl overflow-hidden" style={{ backgroundColor: Colorizer("#25BE8B", 0.4) }} onPress={onClose}>
            <Text className="text-white text-lg" style={{ fontFamily: "PlayfairDisplay_Regular" }}>
              OK
            </Text>
          </TouchableOpacity>
        </View>
    ...
    <View className="absolute inset-0 justify-center items-center">
      ...
      <Animated.View className="w-4/5 rounded-3xl p-5 border-4" style={[{ backgroundColor: Colorizer("#0C0C0C", 1.0), borderColor: Colorizer("#FFFFFF", 1.0) }, modalStyle]}>
        <View className="items-center">
          ...
          <Text className="mt-2.5 text-5xl" style={{ fontFamily: "PlayfairDisplay_Regular", color: Colorizer("#FFFFFF", 1.0) }}>
            Error
          </Text>
          <Text className="my-2.5 text-center text-lg" style={{ fontFamily: "PlayfairDisplay_Regular", color: Colorizer("#FFFFFF", 1.0) }}>
            {message}
          </Text>
    ...
    <View className="absolute inset-0 justify-center items-center">
      ...
      <View className="w-4/5 rounded-3xl p-5 border-4" style={{ backgroundColor: Colorizer("#0C0C0C", 1.0), borderColor: Colorizer(primaryColor, 1.0) }}>
        <View className="items-center">
          ...
          <Text className="mt-2.5 text-5xl" style={{ fontFamily: "PlayfairDisplay_Regular", color: Colorizer(primaryColor, 1.0) }}>
            Downloading...
          </Text>
          <Text className="mt-4 text-3xl" style={{ color: Colorizer(primaryColor, 1.0), fontFamily: "PlayfairDisplay_Regular" }}>
          ...
          <View className="flex-row justify-between w-full mt-4">
            <Text className="text-lg" style={{ color: Colorizer(primaryColor, 1.0), fontFamily: "PlayfairDisplay_Regular" }}>
    ...
    <View className="relative">
      {imageLoading && (
        <View className="absolute inset-0 z-40 justify-center items-center" style={{ backgroundColor: Colorizer("#0C0C0C", 1.0) }}>
          ...
          <Text className="mt-2.5" style={{ fontFamily: "PlayfairDisplay_Regular", color: Colorizer(selectedImage.primary, 1.0) }}>
  ...
  return (
    <View className="p-1 my-2 rounded-2xl" style={{ backgroundColor: Colorizer(primaryColor, 0.2) }}>
      <View className="p-1 rounded-2xl" style={{ backgroundColor: Colorizer(tertiaryColor, 0.2) }}>
        <Text className="ml-2 text-xl" style={{ fontFamily: "PlayfairDisplay_Regular", color: Colorizer("#FFFFFF", 1.0) }}>
          Other Wallpapers:
        </Text>
            ...
            return (
              ...
              >
                ...
                <View className="absolute top-1 left-1 bg-black/50 px-1 py-1 rounded-lg">
                  <Text className="text-white text-xs" style={{ fontFamily: "PlayfairDisplay_Regular" }}>
    ...
    <View className="absolute inset-0 justify-center items-center">
      ...
      <Animated.View className="w-4/5 rounded-3xl p-5 border-4" style={[{ backgroundColor: Colorizer("#0C0C0C", 1.0), borderColor: Colorizer(primaryColor, 1.0) }, modalStyle]}>
        <View className="items-center">
          ...
          <Text className="my-2.5 text-center text-lg" style={{ fontFamily: "PlayfairDisplay_Regular", color: Colorizer(primaryColor, 1.0) }}>
            Due to Android's Material Style, the system UI will restart after setting the wallpaper. This is normal behavior.
          </Text>
          <Text className="text-6xl my-4" style={{ fontFamily: "PlayfairDisplay_Regular", color: Colorizer(primaryColor, 1.0) }}>
            {countdown}
          </Text>
          <TouchableOpacity
        ...
        <View style={{ position: "absolute", bottom: 8, left: 10, right: 10, flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
          ...
          >
            ...
            >
              ...
              <Text style={{ fontSize: 12, color: "#FFFFFF", fontFamily: "PlayfairDisplay_Regular" }}>Set LockScreen</Text>
            </TouchableOpacity>
          </LinearGradient>
          <LinearGradient
            end={[1, 0]}
          ...
          >
            ...
            >
              <Ionicons name="image" size={20} color={Colorizer("#FFFFFF", 1.0)} style={{ marginRight: 10 }} />
              <Text style={{ fontSize: 12, color: "#FFFFFF", fontFamily: "PlayfairDisplay_Regular" }}>Set HomeScreen</Text>
            </TouchableOpacity>
          </LinearGradient>
          <LinearGradient
            end={[1, 0]}
          ...
          >
            ...
            >
              <Ionicons name="image" size={20} color={Colorizer("#FFFFFF", 1.0)} style={{ marginRight: 10 }} />
              <Text style={{ fontSize: 12, color: "#FFFFFF", fontFamily: "PlayfairDisplay_Regular" }}>Set BothScreens</Text>
            </TouchableOpacity>
          </LinearGradient>
        </View>
    ...
    <View className="flex-1" style={{ backgroundColor: Colorizer("#0C0C0C", 1.0) }}>
      ...
      <ScrollView className="flex-1">
        ...
        <View className="p-4 border-2 rounded-3xl" style={{ borderColor: Colorizer(selectedImage.primary, 1.0), backgroundColor: Colorizer("#0C0C0C", 1.0) }}>
          <Text className="mb-2 text-3xl text-center" style={{ fontFamily: "PlayfairDisplay_Regular", color: Colorizer(selectedImage.primary, 1.0) }}>
          ...
          {[
            ...
            <View key={index} className="flex-row items-center my-2">
              ...
              <View className="flex-row items-center mx-1">
                <Text style={{ fontFamily: "PlayfairDisplay_Regular", color: Colorizer(selectedImage.primary, 1.0) }}>{item.label}:</Text>
                <Text className="ml-2" style={{ fontFamily: "PlayfairDisplay_Regular", color: Colorizer(selectedImage.primary, 1.0) }}>
                  {item.value}
                </Text>
              </View>
            </View>
