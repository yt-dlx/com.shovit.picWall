...
// <Text style={{ marginTop: 10, fontFamily: "Lobster", color: colorize("#F4F4F5", 1.0) }}> Loading HD Image Preview... </Text>
// </View>
// )}
...
// >
// <Text style={{ color: colorize("#F4F4F5", 1.0), fontSize: 18, fontFamily: "Lobster" }}> Set as Wallpaper </Text>
// <FontAwesome6 name="mobile-button" size={15} color={colorize("#F4F4F5", 1.0)} style={{ marginHorizontal: 4 }} />
// <Text style={{ color: colorize("#F4F4F5", 1.0), fontSize: 18, fontFamily: "Lobster" }}> (Full-Screen View) </Text>
// </TouchableOpacity>
// </View>
// );
// });
...
// style={{ marginTop: 8, borderRadius: 15, overflow: "hidden", backgroundColor: colorize(colors.primary, 0.4), minHeight: 44 }}
// >
...
// return (
// <View style={{ padding: 4, marginVertical: 8, borderRadius: 15 }}>
...
// <TouchableOpacity
// key={idx}
// style={{ position: "relative", borderRadius: 15, overflow: "hidden", marginHorizontal: 2, flex: 1, aspectRatio: 9 / 16, borderWidth: 2, borderColor: colorize(primaryColor, 1.0) }}
...
// >
// <Text style={{ color: colorize("#F4F4F5", 1.0), fontSize: 18, fontFamily: "Lobster" }}> Cancel </Text>
// </TouchableOpacity>
// </View>
// </Animated.View>
// </View>
...
// style={{ flex: 1, height: 40, borderTopLeftRadius: 5, borderBottomLeftRadius: 5, marginHorizontal: 1 }}
// >
// <TouchableOpacity
...
// <Text style={{ fontSize: 12, color: colorize("#F4F4F5", 1.0), fontFamily: "Lobster" }}>Set LockScreen</Text>
// </TouchableOpacity>
// </LinearGradient>
// <LinearGradient end={[1, 0]} start={[0, 0]} style={{ flex: 1, height: 40, marginHorizontal: 1 }} colors={[colorize("#111111", 0.8), colorize("#111111", 0.8), colorize("#111111", 0.8)]}>
// <TouchableOpacity
// style={{ flexDirection: "row", justifyContent: "center", alignItems: "center", height: "100%" }}
// onPress={() => {
// setWallType("HOME");
...
// >
// <Ionicons name="image" size={20} color={colorize("#F4F4F5", 1.0)} style={{ marginRight: 10 }} />
// <Text style={{ fontSize: 12, color: colorize("#F4F4F5", 1.0), fontFamily: "Lobster" }}>Set HomeScreen</Text>
// </TouchableOpacity>
// </LinearGradient>
// <LinearGradient
// end={[1, 0]}
// start={[0, 0]}
// colors={[colorize("#111111", 0.8), colorize("#111111", 0.8), colorize("#111111", 0.8)]}
// style={{ flex: 1, height: 40, borderTopRightRadius: 5, borderBottomRightRadius: 5, marginHorizontal: 1 }}
// >
// <TouchableOpacity
// style={{ flexDirection: "row", justifyContent: "center", alignItems: "center", height: "100%" }}
// onPress={() => {
...
// >
// <Ionicons name="image" size={20} color={colorize("#F4F4F5", 1.0)} style={{ marginRight: 10 }} />
// <Text style={{ fontSize: 12, color: colorize("#F4F4F5", 1.0), fontFamily: "Lobster" }}>Set BothScreens</Text>
// </TouchableOpacity>
// </LinearGradient>
// </View>
...
// <View style={{ padding: 4, borderWidth: 2, backgroundColor: colorize("#111111", 1.0) }}>
// <Text style={{ margin: 8, fontSize: 30, textAlign: "center", fontFamily: "Lobster", color: colorize("#F4F4F5", 1.0) }}>Title: {selectedImage.original_file_name.replace(".jpg", "")}</Text>
...
const SuccessModal: React.FC<{ visible: boolean; message: string; onClose: () => void }> = memo(({ visible, message, onClose }) => {
  ...
  return (
    <View style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, justifyContent: "center", alignItems: "center" }}>
      <Animated.View style={[{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, backgroundColor: colorize("#111111", 0.5) }, backdropStyle]} />
      <Animated.View
        style={[{ width: "80%", borderRadius: wp("6%"), padding: wp("5%"), borderWidth: 4, backgroundColor: colorize("#111111", 1.0), borderColor: colorize("#25BE8B", 1.0) }, modalStyle]}
      >
        <View style={{ alignItems: "center" }}>
          <Ionicons name="checkmark-done-circle" size={wp("12%")} color={colorize("#25BE8B", 1.0)} />
          <Text style={{ marginTop: hp("2%"), fontSize: wp("12%"), fontFamily: "Lobster", color: colorize("#F4F4F5", 1.0) }}> Success </Text>
          <Text style={{ marginVertical: hp("2%"), textAlign: "center", fontSize: wp("5%"), fontFamily: "Markazi", color: colorize("#F4F4F5", 1.0) }}> {message} </Text>
          <TouchableOpacity
            style={{
              marginTop: hp("2%"),
            ...
            accessibilityLabel="Close success modal"
          >
            <Text style={{ color: colorize("#F4F4F5", 1.0), fontSize: wp("6%"), fontFamily: "Markazi" }}> OK </Text>
          </TouchableOpacity>
        </View>
      </Animated.View>
    </View>
...
const ErrorModal: React.FC<{ visible: boolean; message: string; onClose: () => void }> = memo(({ visible, message, onClose }) => {
  ...
  return (
    <View style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, justifyContent: "center", alignItems: "center" }}>
      <Animated.View style={[{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, backgroundColor: colorize("#111111", 0.5) }, backdropStyle]} />
      <Animated.View
        style={[{ width: "80%", borderRadius: wp("6%"), padding: wp("5%"), borderWidth: 4, backgroundColor: colorize("#111111", 1.0), borderColor: colorize("#F4F4F5", 1.0) }, modalStyle]}
      >
        <View style={{ alignItems: "center" }}>
          <MaterialIcons name="error" size={wp("12%")} color={colorize("#F4F4F5", 1.0)} />
          <Text style={{ marginTop: hp("2%"), fontSize: wp("12%"), fontFamily: "Lobster", color: colorize("#F4F4F5", 1.0) }}> Error </Text>
          <Text style={{ marginVertical: hp("2%"), textAlign: "center", fontSize: wp("5%"), fontFamily: "Markazi", color: colorize("#F4F4F5", 1.0) }}> {message} </Text>
          <TouchableOpacity
            style={{
              marginTop: hp("2%"),
...
const DownloadingModal: React.FC<{ visible: boolean; percentage: number; downloadRate: number; eta: number; primaryColor: string }> = memo(
  ({ visible, percentage, downloadRate, eta, primaryColor }) => {
    ...
    return (
      <View style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, justifyContent: "center", alignItems: "center" }}>
        <View style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, backgroundColor: colorize("#111111", 0.5) }} />
        <View style={{ width: "80%", borderRadius: wp("6%"), padding: wp("5%"), borderWidth: 4, backgroundColor: colorize("#111111", 1.0), borderColor: colorize(primaryColor, 1.0) }}>
          <View style={{ alignItems: "center" }}>
            <MaterialIcons name="cloud-download" size={wp("12%")} color={colorize(primaryColor, 1.0)} />
            <Text style={{ marginTop: hp("2%"), fontSize: wp("12%"), fontFamily: "Lobster", color: colorize("#F4F4F5", 1.0) }}> Downloading.</Text>
            <Text style={{ marginTop: hp("1%"), fontSize: wp("8%"), fontFamily: "Markazi", color: colorize("#F4F4F5", 1.0) }}> {percentage.toFixed(1)}% </Text>
            <View style={{ width: "100%", height: hp("2%"), borderRadius: wp("5%"), overflow: "hidden", marginTop: hp("2%"), backgroundColor: colorize("#242424", 1.0) }}>
              <Animated.View style={{ width: widthInterpolated, backgroundColor: colorize(primaryColor, 1.0), height: "100%" }} />
            </View>
...
const DownloadButton: React.FC<DownloadButtonProps> = memo(({ onDownload, colors }) => {
  ...
  return (
    <TouchableOpacity
      ...
      onPress={onDownload}
      accessibilityLabel="Download wallpaper"
      style={{ marginTop: hp("2%"), borderRadius: wp("3%"), overflow: "hidden", backgroundColor: colorize(colors.primary, 0.4), minHeight: hp("6%") }}
    >
      <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "center", padding: wp("4%") }}>
        ...
        {uniqueImages.map(({ img, idx }) => {
          ...
          return (
            ...
            >
              ...
              >
                <Text style={{ color: colorize("#F4F4F5", 1.0), fontSize: wp("3.5%"), fontFamily: "Markazi" }}> {img.original_file_name.replace(".jpg", "")} </Text>
              </View>
            </TouchableOpacity>
          );
        })}
...
const WallModal: React.FC<WallModalProps> = memo(({ visible, onComplete, onCancel, wallType, primaryColor }) => {
  ...
  return (
    <View style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, justifyContent: "center", alignItems: "center" }}>
      <Animated.View style={[{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, backgroundColor: colorize("#111111", 0.5) }, backdropStyle]} />
      <Animated.View
        style={[{ width: "80%", borderRadius: wp("6%"), padding: wp("5%"), borderWidth: 4, backgroundColor: colorize("#111111", 1.0), borderColor: colorize(primaryColor, 1.0) }, modalStyle]}
      >
        <View style={{ alignItems: "center" }}>
          <MaterialIcons name="warning" size={wp("12%")} color={colorize(primaryColor, 1.0)} />
          <Text style={{ marginTop: hp("2%"), fontSize: wp("12%"), fontFamily: "Lobster", color: colorize("#F4F4F5", 1.0) }}>
            {wallType === "BOTH" ? "Setting Both Screens" : wallType === "HOME" ? "Setting HomeScreen" : "Setting LockScreen"}
          </Text>
          <Text style={{ marginVertical: hp("2%"), textAlign: "center", fontSize: wp("5%"), fontFamily: "Markazi", color: colorize("#F4F4F5", 1.0) }}>
            Due to Android&apos;s Material Style, the system UI will restart after setting the wallpaper. This is normal behavior.
          </Text>
          <Text style={{ marginVertical: hp("2%"), fontSize: wp("12%"), fontFamily: "Markazi", color: colorize("#F4F4F5", 1.0) }}> {countdown} </Text>
          <TouchableOpacity
            style={{
              marginTop: hp("2%"),
              paddingHorizontal: wp("5%"),
            ...
            accessibilityLabel="CancelWallpaperSetting"
          >
            <Text style={{ color: colorize("#F4F4F5", 1.0), fontSize: wp("6%"), fontFamily: "Lobster" }}> Cancel </Text>
          </TouchableOpacity>
        </View>
      </Animated.View>
    </View>
      ...
      <View style={{ flex: 1, backgroundColor: colorize("#111111", 1.0) }}>
        ...
        <View style={{ position: "absolute", bottom: hp("2%"), left: wp("3%"), right: wp("3%"), flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
          <LinearGradient
            ...
            start={[0, 0]}
            colors={[colorize("#111111", 0.8), colorize("#111111", 0.8), colorize("#111111", 0.8)]}
            style={{ flex: 1, height: hp("6%"), borderTopLeftRadius: wp("2%"), borderBottomLeftRadius: wp("2%"), marginHorizontal: wp("1%") }}
          >
            <TouchableOpacity
              style={{ flexDirection: "row", justifyContent: "center", alignItems: "center", height: "100%" }}
              onPress={() => {
            ...
            >
              ...
              <Text style={{ fontSize: wp("3.5%"), color: colorize("#F4F4F5", 1.0), fontFamily: "Lobster" }}>Set LockScreen</Text>
            </TouchableOpacity>
          </LinearGradient>
          <LinearGradient
            end={[1, 0]}
          ...
          >
            ...
            >
              <Ionicons name="image" size={wp("5%")} color={colorize("#F4F4F5", 1.0)} style={{ marginRight: wp("2%") }} />
              <Text style={{ fontSize: wp("3.5%"), color: colorize("#F4F4F5", 1.0), fontFamily: "Lobster" }}>Set HomeScreen</Text>
            </TouchableOpacity>
          </LinearGradient>
          <LinearGradient
            end={[1, 0]}
            start={[0, 0]}
            colors={[colorize("#111111", 0.8), colorize("#111111", 0.8), colorize("#111111", 0.8)]}
            style={{ flex: 1, height: hp("6%"), borderTopRightRadius: wp("2%"), borderBottomRightRadius: wp("2%"), marginHorizontal: wp("1%") }}
          >
            <TouchableOpacity
              style={{ flexDirection: "row", justifyContent: "center", alignItems: "center", height: "100%" }}
              onPress={() => {
            ...
            >
              <Ionicons name="image" size={wp("5%")} color={colorize("#F4F4F5", 1.0)} style={{ marginRight: wp("2%") }} />
              <Text style={{ fontSize: wp("3.5%"), color: colorize("#F4F4F5", 1.0), fontFamily: "Lobster" }}>Set BothScreens</Text>
            </TouchableOpacity>
          </LinearGradient>
        </View>
        <WallModal visible={showWallModal} onComplete={handleWallpaperSet} onCancel={() => setShowWallModal(false)} wallType={wallType} primaryColor={selectedImage.primary} />
    ...
    <View style={{ flex: 1, backgroundColor: colorize("#111111", 1.0) }}>
      ...
      <ScrollView style={{ flex: 1 }}>
        ...
        <View style={{ padding: wp("2%"), borderWidth: 2, backgroundColor: colorize("#111111", 1.0) }}>
          <Text style={{ margin: wp("2%"), fontSize: wp("7%"), textAlign: "center", fontFamily: "Lobster", color: colorize("#F4F4F5", 1.0) }}>
