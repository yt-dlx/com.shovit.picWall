    ...
    <View style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, justifyContent: "center", alignItems: "center", padding: 16, zIndex: 1000 }}>
      ...
      <View style={{ borderRadius: 9999, padding: 4, backgroundColor: colorize("#171819", 0.8), justifyContent: "center", alignItems: "center" }}>
        <Image
          ...
          style={{ width: 150, height: 150, borderWidth: 1, borderRadius: 9999, borderColor: colorize("#F4F4F5", 1.0) }}
        />
      </View>
      <View style={{ alignItems: "center" }}>
        ...
        <Text style={{ paddingHorizontal: 8, fontSize: 20, marginBottom: 16, fontFamily: "Kurale", color: colorize("#F4F4F5", 1.0) }}>Please update the app to continue using picWall</Text>
        <TouchableOpacity
          style={{ marginTop: 10, paddingHorizontal: 32, paddingVertical: 16, borderRadius: 16, overflow: "hidden", backgroundColor: colorize("#F4F4F5", 1.0), minWidth: 200, minHeight: 44 }}
                ...
                >
                  <View style={[{ shadowColor: colorize("#171819", 1.0), shadowOffset: { width: 0, height: 4 } }]}>
                    <View style={{ paddingVertical: 16, flexDirection: "row", alignItems: "center", justifyContent: "center", backgroundColor: colorize("#F4F4F5", 1.0) }}>
                      ...
                      <Text style={{ fontSize: 35, fontFamily: "Jersey", color: colorize("#171819", 1.0) }}> Let&apos;s Explore </Text>
                    </View>
                  </View>
                </TouchableOpacity>
              </Link>
