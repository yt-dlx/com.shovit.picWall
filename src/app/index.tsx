  ...
  return (
    <View style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, justifyContent: "center", alignItems: "center", padding: wp(4), zIndex: 1000 }}>
      ...
      <View style={{ alignItems: "center" }}>
        ...
        <Text style={{ paddingHorizontal: wp(4), fontSize: rf(20), marginBottom: hp(2), fontFamily: "Kurale", color: colorize("#F4F4F5", 1.0) }}>Please update the app to continue using picWall</Text>
        <TouchableOpacity
        ...
        >
          <Text style={{ fontSize: rf(20), fontFamily: "Kurale", color: colorize("#111111", 1.0) }}>Update Now</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
          ...
          <View style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, justifyContent: "center", alignItems: "center", marginTop: hp(8) }}>
            ...
            <Animated.View entering={FadeInDown.delay(600).duration(1500).springify()}>
              ...
              <Animated.View entering={FadeIn.delay(1200).duration(1500)} style={{ marginTop: hp(1.5), paddingHorizontal: wp(5), alignItems: "center" }}>
                <Text style={{ fontFamily: "Kurale", color: colorize("#FF000D", 1.0), fontSize: rf(15), marginBottom: hp(0.5) }}>Perfect AI Wallpapers, Every Day!</Text>
                <Text style={{ fontFamily: "Kurale", color: colorize("#F4F4F5", 0.9), fontSize: rf(10), maxWidth: wp(80) }}>
