        ...
        >
          ...
          {adError && (
            <View className="mt-4 items-center">
              <Text className="text-red-500 text-center mb-2" style={{ fontFamily: "PlayfairDisplay_Regular" }}>
          ...
          {!adError && (
            <View className="mt-6 items-center">
              <Text className="text-white text-lg text-center mb-4" style={{ fontFamily: "PlayfairDisplay_Regular" }}>
                Preparing Your Experience
              </Text>
              <Text className="text-white/60 text-sm text-center" style={{ fontFamily: "PlayfairDisplay_Regular" }}>
                After watching the ad, you'll be redirected to your selected content.
              </Text>
              <Text className="text-white text-lg text-center mt-4" style={{ fontFamily: "PlayfairDisplay_Regular" }}>
