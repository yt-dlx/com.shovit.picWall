        ...
        <CardContainer>
          ...
          {adError ? (
            <View style={{ alignItems: "center", marginTop: hp("2%") }}>
              <Text style={{ color: colorize("#FF6B6B", 1.0), fontSize: wp("4%"), fontFamily: "Lobster", textAlign: "center", marginBottom: hp("1%") }}> Reward not received. Please try again. </Text>
            </View>
          ) : (
            <View style={{ alignItems: "center", marginTop: hp("2%") }}>
              <Text style={{ color: colorize("#F4F4F5", 1.0), fontSize: wp("5.5%"), fontFamily: "Lobster", fontWeight: "600", marginBottom: hp("2%") }}> Preparing Your Experience </Text>
