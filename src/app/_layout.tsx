...
export default function RootLayout() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colorize("#000000", 1.0) }}>
      <StatusBar backgroundColor="#000000" barStyle="light-content" />
      <LinearGradient
        colors={[colorize("#000000", 1.0), colorize("#000000", 0.8), colorize("#000000", 0.6), colorize("#000000", 0.4), colorize("#000000", 0.2), "transparent"]}
        style={{ position: "absolute", top: 0, left: 0, right: 0, height: 100, zIndex: 50 }}
      />
      <View style={{ flex: 1, backgroundColor: colorize("#000000", 1.0) }} className="capitalize">
