...
const SuccessModal: React.FC<{ visible: boolean; message: string; onClose: () => void }> = memo(({ visible, message, onClose }) => {
  ...
  return (
    <View style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, justifyContent: "center", alignItems: "center" }}>
      <Animated.View
        style={[{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, backgroundColor: colorize("#111111", 0.5) }, backdropStyle]}
      />
      <Animated.View
        style={[
          {
      ...
      <View style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, justifyContent: "center", alignItems: "center" }}>
        ...
        >
          <View style={{ alignItems: "center" }}>
            ...
            <View
              style={{ width: "100%", height: 12, borderRadius: 9999, overflow: "hidden", marginTop: 16, backgroundColor: colorize("#242424", 1.0) }}
            >
...
/* ============================================================================================================================== */
/* ============================================================================================================================== */
const PreviewImage: React.FC<{ selectedImage: ImageMetadata; screenWidth: number; onViewFullScreen: () => void }> = memo(
...
/* ============================================================================================================================== */
/* ============================================================================================================================== */
const SubImages: React.FC<OtherImagesProps> = memo(
  ({ otherImages, setCurrentIndex, primaryColor, tertiaryColor, currentIndex, selectedFileName }) => {
        ...
        <View style={{ flexDirection: "row", flexWrap: "wrap", marginVertical: 4 }}>
          {uniqueImages.map(({ img, idx }) => {
            ...
            return (
              ...
              >
                <Image
                  alt={`WallpaperThumbnail${lowResLink}`}
                  source={{ uri: lowResLink }}
                ...
                >
                  <Text style={{ color: colorize("#F4F4F5", 1.0), fontSize: 12, fontFamily: "Markazi" }}>
...
/* ============================================================================================================================== */
/* ============================================================================================================================== */
const FullScreenView: React.FC<FullScreenViewProps> = memo(
  ({ isFullScreen, setIsFullScreen, selectedImage, selectedIndex, data, environment_title }) => {
    ...
    return (
      ...
      >
        <View style={{ flex: 1, backgroundColor: colorize("#111111", 1.0) }}>
          ...
          <WallModal
            visible={showWallModal}
            onComplete={handleWallpaperSet}
    ...
    <View style={{ flex: 1, backgroundColor: colorize("#111111", 1.0) }}>
      ...
      <ScrollView style={{ flex: 1 }}>
        ...
        <View style={{ padding: 4, borderWidth: 2, backgroundColor: colorize("#111111", 1.0) }}>
          <Text style={{ margin: 8, fontSize: 30, textAlign: "center", fontFamily: "Lobster", color: colorize("#F4F4F5", 1.0) }}>
            Title: {selectedImage.original_file_name.replace(".jpg", "")}
          </Text>
          <DownloadButton
            onDownload={downloadAndSaveImage}
            colors={{ primary: selectedImage.primary, secondary: selectedImage.secondary, tertiary: selectedImage.tertiary }}
          />
          <SubImages
